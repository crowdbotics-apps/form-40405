"""
Django settings for form_40405 project.
...
WSGI_APPLICATION = 'form_40405.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "form_40405 API",
    "DESCRIPTION": "API documentation for form_40405 App",
    "VERSION": "v1",
}
